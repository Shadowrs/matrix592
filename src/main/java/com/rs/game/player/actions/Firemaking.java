...
public class Firemaking extends Action {
	...
	public static enum Fire {
		NORMAL(1511, 1, 300, 40, 20), ACHEY(2862, 1, 300, 40, 1), OAK(1521, 15, 450, 60, 1), WILLOW(1519, 30, 450, 90, 1), TEAK(6333, 35, 450, 105, 1), ARCTIC_PINE(10810, 42, 500, 125, 1), MAPLE(1517, 45, 500, 135, 1), MAHOGANY(6332, 50, 700, 157.5, 1), EUCALYPTUS(12581, 58, 700, 193.5, 1), YEW(1515, 60, 800, 202.5, 1), MAGIC(1513, 75, 900, 303.8, 1), CURSED_MAGIC(13567, 82, 1000, 303.8, 1);
		...
		Fire(int logId, int level, int life, double xp, int time) {
			this.logId = logId;
			this.level = level;
			this.life = life;
			this.xp = xp;
